...
XMRMetrics=$(curl -X GET -H "X-CMC_PRO_API_KEY: REDACTED_CMC_KEY" -H "Accept: application/json" -d "symbol=XMR" -G https://pro-api.coinmarketcap.com/v2/cryptocurrency/quotes/latest)
